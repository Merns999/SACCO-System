...
namespace SACCO_System.Migrations
{
    ...
    partial class SharesidSaccoContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("SACCO_System.Models.ShareTransfer", b =>
                {
                    ...
                    b.HasOne("SACCO_System.Models.Account", "ReceiverAccount")
                        .WithMany()
                        .HasForeignKey("ReceiverAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("share_transfer_receiver_account_fk");
                    ...
                    b.HasOne("SACCO_System.Models.Account", "SenderAccount")
                        .WithMany()
                        .HasForeignKey("SenderAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("share_transfer_sender_account_fk");
